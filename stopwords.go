...
//LoadStopWords is a Utility function to split the long string of stop words a slice of stop words
func LoadStopWords() []string {
	stopWords := []string{}

	substrings := strings.Split(stopWordsString, "\n")
